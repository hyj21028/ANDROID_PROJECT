...
public class JasonParser {
    static public int getUserInfoJason(String response, ArrayList<UserInfo> userList) throws JSONException {
        ...
        JSONObject rootJSON = new JSONObject(response); //중괄호가 분리됨
        JSONArray jsonArray = new JSONArray(rootJSON.getString("datas")); //대괄호
